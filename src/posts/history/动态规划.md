---
title: 动态规划
date: 2020-08-02 22:39:29
permalink: /posts/3ed590.html
tag: 
  - 数据结构
---
## 动态规划的定义
...
![最优子结构](https://fastly.jsdelivr.net/gh/yuanmoc/statics/images/image-0f431b69c0f0484d8caaad95494ff8ca.webp)

- 重叠子问题（编程方法）
动态规划是编程的方法指，可以借助编程的技巧去保证每个重叠的子问题只会被求解一次。

![重叠子问题](https://fastly.jsdelivr.net/gh/yuanmoc/statics/images/image-7517c01e06de4466adb823c495587cfb.webp)
...
     偷窃到的最高金额 = 1 + 3 = 4 。
```
![LeetCode516](https://fastly.jsdelivr.net/gh/yuanmoc/statics/images/image-0e8d5913aa2c42cf8ecef7a9140215ee.webp)
